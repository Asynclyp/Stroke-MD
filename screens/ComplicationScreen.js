...
export const complicationScreenHeaderOptions = (navigation) => ({
    title: '',
    headerStyle: {
        ...
        <TouchableOpacity
            ...
            onPress={
                async () => {
                    ...
                    console.log("Moving back to LandingPage from Complication Screen")
                }
            }
...
export default class ComplicationScreen extends Component {
        ...
        return (
            <View style={styles.outerContainer}>
                <View style={styles.innerContainer}>
                    <Text style={styles.fillerText}>Complications</Text>
                </View>
            </View>
        )
    }
