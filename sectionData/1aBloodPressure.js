    ...
    render() {
        return (
            <View style={styles.contentContainer}>
                ...
                <Text style={styles.subTextList}><Text style={styles.boldText}></Text><Text style={styles.subText}>If blood pressure remains >185/110 mm Hg, do not administer tPA.</Text></Text>
                <Text></Text>
