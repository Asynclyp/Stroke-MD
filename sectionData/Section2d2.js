    ...
    render() {
        return (
            <View style={styles.contentContainer}>
                ...
                <Text></Text>
                <Text style={[styles.boldText, styles.SubTextItalic]}> - Early communication will be key to ensure that if there are delays from a NEI standpoint, that thrombolytic is then given in a timely fashion.</Text>
            </View>
        );
    }
}